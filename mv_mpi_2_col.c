...
*/
	...
	// broadcast v among the nodes
	MPI_Bcast(&v[0], n, MPI_DOUBLE, 0, MPI_COMM_WORLD);
	// scatter A among the nodes
	MPI_Scatter(&A[0][0], n*l, MPI_DOUBLE, &A[0][0], n*l, MPI_DOUBLE, 0, MPI_COMM_WORLD); 
	...
	// gather the results
	MPI_Gather(&wp[0], l, MPI_DOUBLE, &wp[0], l, MPI_DOUBLE, 0, MPI_COMM_WORLD);
